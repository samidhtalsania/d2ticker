...
import com.bluealeaf.dota2ticker.models.game.Player__;
 ...
 */
public class DirePlayerDetailsAdapter extends BaseAdapter{
    private Context context;
    private List<Player__> players;
    ...
    public DirePlayerDetailsAdapter(Context context,List<Player__> players){
